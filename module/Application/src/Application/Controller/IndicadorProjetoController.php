    	...
    	if ($request->isPost()) {
    		...
    		if($indicadorProjeto->indicador_projeto_valor > $indicadorProjeto->valor_maximo){
    			...
    			if($quant_fora_limite >= 2){
    				...
    				$this->enviarEmailAltaDirecao($html, utf8_encode('3 ou mais indicadores est�o fora do limite esperado!'));
    			}
													...
													<td width="400" valign="top" style="padding-top:40px;padding-bottom:20px;">
														...
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable" >
																<div style="font-size:23px;font-family:Heveltica, Arial, sans-serif;color:#fff;">'.utf8_encode('3 ou mais indicadores est�o fora do limite esperado!').'</div>
															</div>
														</div>
														...
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable"  style="padding:20px 10px 0 0;margin:0;font-family:Helvetica, Arial, sans-serif;font-size:15px;line-height:150%;">
																<p style="color:#FFEECE;">'.utf8_encode('Sistema de Gerenciamento de Portif�lio de Projetos').'</strong></p>
															</div>
														</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										<td width="60%" height="70" valign="middle" style="padding-bottom:20px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">'.utf8_encode('Sistema de Gerenciamento de Portif�lio de Projetos').' by Laislla Ramos</span>
													<br/>
