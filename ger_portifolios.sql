...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Ago-2016 às 23:26
...
(8, 1, 24, 'Iniciação', 1, 2, 1, NULL, NULL);
...
--
ALTER TABLE `funcionalidade`
  MODIFY `funcionalidade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `perfil_acesso`
  MODIFY `perfil_acesso_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
